"""
Django settings for My SaaS App project.
...
SECRET_KEY = env("SECRET_KEY", default="django-insecure-yMaLzaJ56zZrfxvC89dbvVQ6Y2mRK14SAUZHzCEc")
...
WSGI_APPLICATION = "my_saas_app.wsgi.application"
...
if "DATABASE_URL" in env:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": env("DJANGO_DATABASE_NAME", default="my_saas_app"),
...
LANGUAGE_CODE = "en-us"
LANGUAGE_COOKIE_NAME = "my_saas_app_language"
...
EMAIL_SUBJECT_PREFIX = "[My SaaS App] "
...
ASGI_APPLICATION = "my_saas_app.asgi.application"
CHANNEL_LAYERS = {
    "default": {
...
WAGTAIL_SITE_NAME = "My SaaS App Content"
...
STABILITY_AI_API_KEY = env("STABILITY_AI_API_KEY", default="")
...
LOGGING = {
    ...
    "loggers": {
        ...
        "my_saas_app": {
            "handlers": ["console"],
            "level": env("MY_SAAS_APP_LOG_LEVEL", default="INFO"),
        },
    },
}
